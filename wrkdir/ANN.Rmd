...
```{r}
hitters_scale_train = scale(hitters_train[-c(14,15,20)])
...
hitters_scale_val = as.data.frame(scale(hitters_val[-c(14,15,20)], center = hitters_mean_train, scale = hitters_stddevs_train))
...
hitters_scale_test = as.data.frame(scale(hitters_test[-c(14,15,20)], center = hitters_mean_train, scale = hitters_stddevs_train))
